...
with DAG(
    ...
    gcs_2_bg_ext_task = BigQueryCreateExternalTableOperator(
        task_id="gcs_2_bg_ext_task",
        table_resource={
            "tableReference": {
    ...
    CREATE_PART_TBL_QUERY = f"CREATE OR REPLACE TABLE {BIGQUERY_DATASET}.yellow_tripdata_partioned \
    PARTITION BY \
    ...
    gcs_2_gcs_task >> gcs_2_bg_ext_task >> bq_ext_2_part_task
